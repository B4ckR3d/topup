...
import { and, eq, inArray } from '@umbreon/db'
import { AppPlatform, ProductGroupingMenuType, ProductGroupingType, tb } from '@umbreon/db/types'
  ...
  async updateProductSection(ctx: HttpContext) {
    ...
    await db
      ...
      .set({
        ...
        platform,
        type,
        menu_type: menu_type || productSection.menu_type,
        is_available,
        is_featured,
        label,
        order,
