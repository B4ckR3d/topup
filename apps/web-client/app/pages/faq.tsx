...
export default function Faq() {
  ...
  const faqs: { q: string; a: string }[] = [
    {
      q: 'Apa itu Umbreon Store?',
      a: 'Umbreon Store adalah platform topup game dan PPOB untuk pulsa, paket data, e-wallet, tagihan, dan voucher digital dengan proses cepat dan aman.',
    },
    {
    ...
    },
    {
      ...
      a: 'Mohon periksa kembali data sebelum pembayaran. Kesalahan input oleh pengguna tidak menjadi tanggung jawab Umbreon Store, namun Anda dapat menghubungi support untuk pengecekan lanjutan.',
    },
  ]
