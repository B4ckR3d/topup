...
export default function Contact() {
  ...
  const TELEGRAM_URL = 'https://t.me/umbreonstore' // TODO: ganti dengan username Telegram resmi
  const INSTAGRAM_URL = 'https://instagram.com/umbreonstore' // TODO: ganti dengan username Instagram resmi
  const FACEBOOK_URL = 'https://facebook.com/umbreonstore' // TODO: ganti dengan halaman Facebook resmi
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setLoading(true)
    const body = `Halo Umbreon Store,%0D%0A%0D%0A${encodeURIComponent(
      message,
