...
export default function Support() {
  ...
  const TELEGRAM_URL = 'https://t.me/umbreonstore'
  const INSTAGRAM_URL = 'https://instagram.com/umbreonstore'
  const FACEBOOK_URL = 'https://facebook.com/umbreonstore'
        ...
        <div className="divide-y divide-border mt-3">
          ...
          <details className="group py-3">
            ...
            <div className="mt-2 text-sm text-muted-foreground leading-6">
              ...
              luar tanggung jawab Umbreon Store, namun kami tetap akan bantu cek.
            </div>
          </details>
        </div>
      </section>
