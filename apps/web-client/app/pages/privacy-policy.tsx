    ...
    <div className="md:max-w-7xl mx-auto">
      ...
      <section className="mt-10 space-y-8">
        <Block title="1. Ruang Lingkup">
          <p>
            Kebijakan ini berlaku untuk semua layanan Umbreon Store, termasuk situs web dan
            aplikasi. Dengan menggunakan layanan kami, Anda menyetujui praktik yang dijelaskan di
            sini serta{' '}
